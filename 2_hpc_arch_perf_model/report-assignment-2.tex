...
Simulations for $10e8 Bytes$ and larger array sizes fail to run on one CPU due to running out of memory (Slurm returning OOM error). 
We chose the biggest possible constellation with $10e7$.
