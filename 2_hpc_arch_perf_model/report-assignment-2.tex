...
We retreive the Architecture using \verb|hwloc-ls --of svg > topology.svg| and then copying the file from the cluster to our repository using the securecopy \verb|scp| command. The resulting graphical representation can be seen below.
\begin{figure}
  \includesvg[width=\textwidth]{img\topology.svg}
